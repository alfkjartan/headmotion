...
//use for SQL commands DROP and INSERT and UPDATE
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            db.update(
                "INSERT INTO sample_table(str_col,num_col) VALUES('Aston Martin', 1000)");
            db.update(
                "INSERT INTO sample_table(str_col,num_col) VALUES('Mercedez', 2200)");
            db.update(
                "INSERT INTO sample_table(str_col,num_col) VALUES('BMW', 1300)");
            db.update(
                "INSERT INTO sample_table(str_col,num_col) VALUES('MG', 400)");
